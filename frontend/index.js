...
document.querySelector('#citySelect').addEventListener('change', async evt => {
  ...
  try {
    ...
    document.querySelector('#todayStats div:nth-child(2)').textContent = `Percipitation: ${data.current.percipitation_probability * 100}%`
    ...
    data.forecast.daily.forEach((day,idx) => {
      ...
      minMax.textContent = `${day.temerature_min}°/${day.temperature_max}°`
